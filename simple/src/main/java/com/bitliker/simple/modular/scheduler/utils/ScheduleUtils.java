package com.bitliker.simple.modular.scheduler.utils;
...
public class ScheduleUtils {
    ...
    public static int loadCalendarAccount(Context context) {
...
//      event.put(CalendarContract.Events.DISPLAY_COLOR, Color.GREEN);//显示颜色
    ...
    private static Schedule getSchedule(Cursor cursor) {
        ...
        Log.i("gong", JSONUtil.toJSONString(mSchedule));
